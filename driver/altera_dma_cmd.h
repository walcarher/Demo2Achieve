...
// MODIFICATIONS
#define ALTERA_CMD_WRITE_TENSOR 		14
#define ALTERA_CMD_READ_TENSOR 			15
...
// MODIFICATIONS
#define ALTERA_IOCX_WRITE_TENSOR            _IO(ALTERA_IOC_MAGIC, ALTERA_CMD_WRITE_TENSOR)
#define ALTERA_IOCX_READ_TENSOR             _IO(ALTERA_IOC_MAGIC, ALTERA_CMD_READ_TENSOR)
